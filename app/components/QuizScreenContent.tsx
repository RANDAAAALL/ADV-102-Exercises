...
export default function QuizScreenContent(){
    ...
    const handleClickGenerate = async () => {
        try{
            if(minimumInput.trim() === "") return setErrorMessage("Invalid input! please enter a value!");
            ...
            if(isNaN(toInt)) {return setErrorMessage("Invalid input! must be a number!")}
                ...
                if(toInt >= 10 && toInt <= 30){
                    ...
                    // console.log("From QuizData: " + quizData[0]);
                    // console.log("Fr om data response: " + data?.results[0]);
                    // console.log("From toDisplayDataQuiz: " + toDisplayQuizData);
                    // console.log(data);
                    // setMinimumInput("");
                    setErrorMessage("");
    ...
    const handleNextClickDisplayQuiz = async (usersAnswer: any) => {
        ...
        if(quizData[quizIndex] && quizData[quizIndex].correct_answer === usersAnswer) {
            setDisplayAnswer("You got it right!");
            setCorrectAnswerIncrementor(prev => prev+1);
            setIsCorrect(true);
        }
        else{
            setDisplayAnswer("You got it wrong!");
    ...
    // const handleReloadScreen = async () => {
    //     setIsLoading(true);
    ...
    //     setShuffleCurrentAnswers([]);
    //     setDisplayAnswer("");
    //     setCorrectAnswerIncrementor(0);
    //     setInCorrectAnswerIncrementor(0);
    //     setIsLoading(false);
                                ...
                                <Text style={{
                                    ...
                                    { quizData.length <= 0 ? (
                                        ...
                                        <Text style={{
                                            ...
                                            textAlign: "center"
                                        }}>generate between 10 - 30 random questions</Text>
